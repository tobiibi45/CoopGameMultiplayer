...
#define CoopGame_Source_CoopGame_Public_SWeapon_h_30_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__ActualDamage() { return STRUCT_OFFSET(ASWeapon, ActualDamage); } \
	FORCEINLINE static uint32 __PPO__HeadShotDamage() { return STRUCT_OFFSET(ASWeapon, HeadShotDamage); } \
	FORCEINLINE static uint32 __PPO__ChestShotDamage() { return STRUCT_OFFSET(ASWeapon, ChestShotDamage); } \
	FORCEINLINE static uint32 __PPO__RateOfFire() { return STRUCT_OFFSET(ASWeapon, RateOfFire); } \
	FORCEINLINE static uint32 __PPO__TotalAmmoCapacity() { return STRUCT_OFFSET(ASWeapon, TotalAmmoCapacity); } \
	FORCEINLINE static uint32 __PPO__AvailableAmmo() { return STRUCT_OFFSET(ASWeapon, AvailableAmmo); } \
	FORCEINLINE static uint32 __PPO__bCanReload() { return STRUCT_OFFSET(ASWeapon, bCanReload); } \
